...
if __name__ == '__main__':
    ...
    if args.cpt_path != "":
        ...
        if args.use_glove:
            ...
            if os.path.isfile(args.embed_cache_path):
                pretrained_emb = torch.load(args.embed_cache_path)
                ...
                pretrained_emb, random_init_words = model.word_embedding.load_pretrained_vectors(
                    args.glove_path, binary=False, normalize=False)
                torch.save(pretrained_emb, args.embed_cache_path)
