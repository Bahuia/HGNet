...
class HGNet(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.plm_config = BertConfig.from_pretrained(args.plm_mode)
        self.encoder = BertModel.from_pretrained(args.plm_mode)
        self.tokenizer = BertTokenizer.from_pretrained(args.plm_mode)
